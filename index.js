require("http").createServer((_, res) => res.end('Sneaky Society Giveaway Is Ready TO Go!')).listen(8080) 
...
client.on("ready", () =>{
    ...
    files.forEach(x =>{
        ...
        client.application?.commands.create({"name": "create-giveaway", "description": "Create A Giveaway", "options": [
          ...
          {
            "name": "req", "description": "The requirements of the giveaway", type: "STRING", required: false
          }
