...
module.exports = {
    ...
    description: "Create A Giveaway With sneaky Society Bot!",
    ...
    run: (client, interaction) =>{
        ...
        let req = interaction.options.getString("req")

        Manager(client , interaction, {"giveawayOption": {"channelID": channel, "prize": prize, "time": time}}, req)
